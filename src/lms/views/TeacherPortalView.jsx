      ...
      <div className="bg-gradient-to-r from-sky-50 via-blue-50 to-white p-6 sm:p-8 rounded-3xl border border-sky-200 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div className="space-y-2">
          ...
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-slate-900 tracking-tight">
            Portal del Docente: <span className="text-[#0284c7]">{currentUser?.nombre || 'Docente Instructor'}</span>
          </h1>
        ...
        <div className="bg-white p-4 rounded-2xl border border-slate-200 min-w-[260px] space-y-1.5 shadow-sm">
          ...
          <div className="flex justify-between items-center text-[10px] text-slate-500 pt-1">
            ...
            <span>Alumnos: <strong className="text-emerald-700">{currentCourse.studentsCount}</strong></span>
          </div>
        </div>
      </div>
      ...
      <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="p-6 rounded-3xl bg-white border border-slate-200 shadow-sm flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              ...
              <button
                ...
                className="bg-[#00c2b2] hover:bg-teal-500 text-white font-black text-xs px-5 py-2.5 rounded-xl shadow-sm flex items-center gap-2 cursor-pointer flex-shrink-0"
              >
                <Plus size={15} />
            ...
            <div className="space-y-3">
              {announcements.map(item => (
                <div key={item.id} className="p-5 rounded-2xl bg-white border border-slate-200 space-y-2 shadow-sm">
                  <div className="flex justify-between items-start">
                    <h4 className="text-sm font-bold text-slate-900">{item.title}</h4>
                    <span className="text-[10px] text-slate-600 bg-slate-100 px-2.5 py-0.5 rounded-full border border-slate-200">{item.date}</span>
                  </div>
                  ...
                  >
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                      <div className="flex items-center gap-2">
                        <span className="text-sm font-bold text-slate-900">{msg.student}</span>
                    ...
                    {msg.status === 'pendiente' && (
                      <div className="flex justify-end pt-1">
                        <button
                          ...
                          className="bg-[#0284c7] hover:bg-sky-600 text-white font-bold text-xs px-4 py-2 rounded-xl shadow-sm cursor-pointer flex items-center gap-1.5"
                        >
                          <Send size={13} />
        ...
        {activeTab === 'archivos' && (
          ...
          >
            ...
            <div className="p-6 rounded-3xl bg-white border border-slate-200 p-6 sm:p-8 space-y-4 shadow-sm">
              <div className="flex items-center gap-2">
                <span className="p-2 rounded-xl bg-sky-100 text-[#0284c7] border border-sky-200">
                  <UploadCloud size={20} />
                </span>
                <div>
                  <h3 className="text-base font-bold text-slate-900">Subir Material Didáctico a la Clase</h3>
                  <p className="text-xs text-slate-600">Los estudiantes podrán descargar estos archivos desde su aula virtual.</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 pt-2">
                <div className="sm:col-span-6">
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-300 rounded-xl px-4 py-2.5 text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:bg-white"
                  />
                </div>
                ...
                <div className="sm:col-span-3">
                  <select
                    ...
                    className="w-full bg-slate-50 border border-slate-300 rounded-xl px-3 py-2.5 text-xs text-slate-800 focus:outline-none focus:border-sky-500 focus:bg-white cursor-pointer"
                  >
                ...
                <div className="sm:col-span-3">
                  <label className="w-full bg-[#0284c7] hover:bg-sky-600 text-white font-bold text-xs py-2.5 px-4 rounded-xl shadow-sm cursor-pointer flex items-center justify-center gap-2 transition-all">
                    <UploadCloud size={14} />
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {materials.map(mat => (
                  <div key={mat.id} className="p-5 rounded-2xl bg-white border border-slate-200 hover:border-sky-400 transition-all flex flex-col justify-between gap-3 shadow-sm group">
            ...
            <div className="p-6 rounded-3xl bg-white border border-slate-200 space-y-4 shadow-sm">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <button
                  ...
                  className="bg-emerald-600 hover:bg-emerald-700 text-white font-black text-xs px-5 py-2.5 rounded-xl shadow-sm flex items-center gap-2 cursor-pointer"
                >
            ...
            <div className="p-6 rounded-3xl bg-white border border-slate-200 space-y-4 shadow-sm">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                  ...
                  <p className="text-xs text-slate-600">Registro oficial exigido por SENCE. Asistencia mínima requerida: 85%.</p>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
                <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200">
                  <div className="text-[10px] uppercase text-slate-500 font-bold">Total Horas Impartidas</div>
                  <div className="text-xl font-black text-slate-900 mt-1">45 / 90 Horas</div>
                  <div className="text-[11px] text-sky-700 font-semibold">Avance cronológico: 50%</div>
                </div>

                <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200">
                  <div className="text-[10px] uppercase text-slate-500 font-bold">Asistencia Promedio Curso</div>
                  <div className="text-xl font-black text-emerald-700 mt-1">92.4%</div>
                  <div className="text-[11px] text-slate-500">Sobre el umbral mínimo (85%)</div>
                </div>

                <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200">
                  <div className="text-[10px] uppercase text-slate-500 font-bold">Sesiones Realizadas</div>
                  <div className="text-xl font-black text-slate-900 mt-1">15 Sesiones</div>
                  <div className="text-[11px] text-slate-500">Bitácora al día</div>
                </div>
              </div>
            </div>
          </motion.div>
